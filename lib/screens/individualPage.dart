import 'package:chat_with_socket/custom_ui/on_messagecard.dart';
import 'package:chat_with_socket/model/chatmodel.dart';
import 'package:chat_with_socket/model/message_model.dart';
...
import '../custom_ui/replay_card.dart';

class IndividualPage extends StatefulWidget {
   IndividualPage({super.key, this.chatModel, this.sourchat});
...
class _IndividualPageState extends State<IndividualPage> {
  ...
  void connect() {
    ...
    socket = IO.io("http://192.168.18.72:5000", <String, dynamic>{
...
print(socket!.connected);
            ...
            child: WillPopScope(
              ...
              child: Column(children: [
                    ...
                    Align(
                                            ...
                                            setState(() {
                                              show = !show;
                                                 showModalBottomSheet(
                                                    ...
                                                    context: context,
                                                    builder: (builder) =>
                                                    emojiPicker(textEditingController: _controller));
                                            });
                                          },
                                        ),
                                        suffixIcon: Row(
                                  ...
                                  //    emojiPicker(textEditingController: _controller) :Container()
                                        ],
                                      ),
                                  ),
                    ),
  ...
  Widget emojiPicker({TextEditingController? textEditingController }){
  return  SizedBox(
    // height: 250,
    child: EmojiPicker(
